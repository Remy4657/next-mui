...
export const getAllProductsPublic = async (data: {
  ...
  try {
    const res = await axios.get(
      `${API_ENDPOINT.MANAGE_PRODUCT.PRODUCT.INDEX}/public`,
      data
    );
...
export const getDetailsProductPublic = async (id: string) => {
  try {
    const res = await axios.get(
      `${API_ENDPOINT.MANAGE_PRODUCT.PRODUCT.INDEX}/public/${id}`
    );
...
export const getDetailsProductPublicBySlug = async (
  slug: string,
  isViewed?: boolean
) => {
  try {
    ...
    const res = await axios.get(
      `${API_ENDPOINT.MANAGE_PRODUCT.PRODUCT.INDEX}/public/slug/${slug}`,
      data
    );
...
export const getListRelatedProductBySlug = async (data: {
  params: TParamsGetRelatedProduct;
}) => {
  try {
    const res = await axios.get(
      `${API_ENDPOINT.MANAGE_PRODUCT.PRODUCT.INDEX}/related`,
      data
    );
...
export const deleteMultipleProduct = async (
  data: TParamsDeleteMultipleProduct
) => {
  try {
    const res = await instanceAxios.delete(
      `${API_ENDPOINT.MANAGE_PRODUCT.PRODUCT.INDEX}/delete-many`,
      { data }
    );
...
export const likeProduct = async (data: { productId: string }) => {
  try {
    const res = await instanceAxios.post(
      `${API_ENDPOINT.MANAGE_PRODUCT.PRODUCT.INDEX}/like`,
      data
    );
    if (res?.data?.status === "Success") {
      return {
...
export const unLikeProduct = async (data: { productId: string }) => {
  try {
    const res = await instanceAxios.post(
      `${API_ENDPOINT.MANAGE_PRODUCT.PRODUCT.INDEX}/unlike`,
      data
    );
    if (res?.data?.status === "Success") {
      return {
...
export const getAllProductsLiked = async (data: {
  params: TParamsGetProducts;
}) => {
  try {
    const res = await instanceAxios.get(
      `${API_ENDPOINT.MANAGE_PRODUCT.PRODUCT.INDEX}/liked/me`,
      data
    );
...
export const getAllProductsViewed = async (data: {
  params: TParamsGetProducts;
}) => {
  try {
    const res = await instanceAxios.get(
      `${API_ENDPOINT.MANAGE_PRODUCT.PRODUCT.INDEX}/viewed/me`,
      data
    );
